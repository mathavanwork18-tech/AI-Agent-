...
export interface AgentVersionMetrics {
  ...
  policyCompliance: number;    // percentage 0-100
  responseQuality: number;     // percentage 0-100
...
export interface TestCase {
  ...
  category: string;
  query: string;
  input: string; // compatibility alias with query
  ...
  expectedBehavior: string; // compatibility alias
  evaluationCriteria: string[];
